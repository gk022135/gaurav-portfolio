  ...
  const testimonials: Testimonial[] = [
    {
      ...
      name: "JavaScript",
      designation: "",
      src: js.src, // ✔️ Converted to string
    },
    {
      quote:
    ...
    {
      quote:
        "Tailwind CSS is a utility-first CSS framework for creating responsive, customizable user interfaces quickly with predefined classes, ensuring clean and maintainable code.",
      name: "TailwindCss",
      designation: "",
      src: Tailwind.src,
    },
    ...
    {
      quote:
        "Postman is a powerful API testing tool that simplifies development by enabling API requests, automation, debugging, documentation, and collaboration in a user-friendly interface.",
      name: "Post Man",
      designation: "",
      src: postman.src,
    },
    {
      quote:
        "Java is a versatile, object-oriented programming language known for its platform independence, robust performance, and security. It’s widely used in web applications, Android development, enterprise software, and backend systems.",
      name: "Java",
      designation: "",
      src: Java.src,
    },
    {
      quote:
        "Docker is a platform that enables developers to build, deploy, and run applications in lightweight, portable containers. It ensures consistency across environments, simplifies development workflows, and supports scalable deployments.",
      name: "Docker",
      designation: "",
      src: Docker.src,
    },
    ...
    {
      quote:
        "MongoDB is a NoSQL, document-oriented database that stores data in flexible JSON-like formats. It offers high performance, scalability, and real-time analytics, making it ideal for modern web and mobile applications.",
      name: "MongoDB",
      designation: "",
      src: MongD.src,
    },
    {
      quote:
        "Express.js is a minimal and flexible Node.js web application framework that provides robust features for building APIs and web applications. It simplifies server-side development with middleware support and routing capabilities.",
      name: "Express Js",
      designation: "",
      src: Express.src,
    },
